...
class _ShowProductPageState extends State<ShowProductPage> {
  ...
  Future<String?> getList() async {
    ...
    var url = Uri.parse('https://laravel-backendbz.herokuapp.com/api/products');
  ...
  Future<void> deleteProduct(int? id) async {
    ...
    var url =
        Uri.parse('https://laravel-backendbz.herokuapp.com/api/products/$id');
  ...
  Future<void> logout() async {
    ...
    var url = Uri.parse('https://laravel-backendbz.herokuapp.com/api/logout');
